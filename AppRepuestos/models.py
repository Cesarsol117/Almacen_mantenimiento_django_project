...
class RegistroEntradasSalidas(models.Model):
    ...
    tipo_movimiento = models.CharField(max_length=10, choices=TIPO_MOVIMIENTO_CHOICES, null=True)
    ...
    def __str__(self):
        return f'tipo de salida : {self.tipo_movimiento } o {self.cantidad}  Maquinas: {self.machine_relation.name} - Repuestos:{self.spare_part_relation.name_spare_part}'
