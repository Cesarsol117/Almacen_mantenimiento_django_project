...
class RegistroEntradasSalidas(models.Model):
    ...
    entregado_a = models.ForeignKey(User, on_delete=models.SET_NULL, related_name='usuario_quien_recibe', null=True, blank=True)
    prestado_por = models.ForeignKey(User, on_delete=models.SET_NULL, related_name='usuario_responsable', null=True, blank=True)
    devolucion_por = models.ForeignKey(User, on_delete=models.SET_NULL, related_name='usuario_que_devuelve', null=True, blank=True)
    devuelto = models.BooleanField(null=True, blank=True)
    se_uso = models.BooleanField(null=True, blank=True)
