...
from AppRepuestos.views import RepuestosListView, SparePartDetailView,search_for_spare_parts , delete_spare_part,create_spare_parts, update_spare_parts, ingreso_spare_parts
